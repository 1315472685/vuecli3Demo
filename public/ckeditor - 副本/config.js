...
//     editor.ui.addButton('UploadImage', { label: '上传本地图片', command: 'insert', icon: 'image', toolbar: 'insert,10' })
//     setTimeout(function () {
//       $('.cke_button__uploadimage_label').parent().map(function () {
//         $(this).attr('data-type', 'png,jpg,gif').uploadFile(function (url) {
//           editor.insertElement(CKEDITOR.dom.element.createFromHtml('<img style="width:100%" src="' + url + '" border="0" title="image">'))
//         })
//       })
//     }, 100)
//   }
