...
CKEDITOR.editorConfig = function (config) {
  ...
  config.filebrowserImageUploadUrl = 'https://36446.cke-cs.com/easyimage/upload/'// 上传图片窗口用到的接口
  ...
  config.extraPlugins = 'uploadimage,colorbutton,panelbutton,floatpanel'// uploadimage粘贴图片时用得到,colorbutton,panelbutton,floatpanel修改字体颜色以及背景
